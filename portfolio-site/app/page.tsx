  ...
  return (
    <section className="md:p-12 pt-0 w-[100%] p-1">
      ...
      <div className="no-scrollbar projects grid grid-cols-1 md:grid-cols-3 gap-3 min-h-[30rem] align-center justify-start">
        <iframe className="w-[100%] md:min-h-[30rem] min-h-[20rem]" src="https://www.behance.net/embed/project/226768985?ilo0=1" allowFullScreen loading="lazy" frameBorder={0} allow="clipboard-write"></iframe>
        <iframe className="w-[100%] md:min-h-[30rem] min-h-[20rem]" src="https://www.behance.net/embed/project/216179409?ilo0=1" allowFullScreen loading="lazy" frameBorder={0} allow="clipboard-write"></iframe>
