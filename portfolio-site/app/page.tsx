...
export default function Home() {
  return (
     <section className="md:p-12 pt-0 w-[100%] p-1">
      ...
      {/* We no longer need the wrapper divs, just the grid container */}
      <div className="projects grid grid-cols-1 md:grid-cols-3 gap-3 min-h-[30rem] align-center justify-start">
        ...
        <iframe 
          className="iframe w-full md:min-h-[30rem] min-h-[20rem] border-0" 
          src="https://www.behance.net/embed/project/230210361?ilo0=1~" 
          allowFullScreen 
          loading="lazy" 
          allow="clipboard-write"
          scrolling="no">
        ...
        <iframe 
          className="iframe w-full md:min-h-[30rem] min-h-[20rem] border-0" 
          src="https://www.behance.net/embed/project/228754617?ilo0=1" 
          allowFullScreen 
          loading="lazy" 
          allow="clipboard-write"
          scrolling="no">
        ...
        <iframe 
          className="iframe w-full md:min-h-[30rem] min-h-[20rem] border-0" 
          src="https://www.behance.net/embed/project/226768985?ilo0=1" 
          allowFullScreen 
          loading="lazy" 
          allow="clipboard-write"
          scrolling="no">
        ...
        <iframe 
          className="iframe w-full md:min-h-[30rem] min-h-[20rem] border-0" 
          src="https://www.behance.net/embed/project/216179409?ilo0=1" 
          allowFullScreen 
          loading="lazy" 
          allow="clipboard-write"
          scrolling="no">
        ...
        <iframe 
          className="iframe w-full md:min-h-[30rem] min-h-[20rem] border-0"
          src="https://www.behance.net/embed/project/205240437?ilo0=1" 
          allowFullScreen 
          loading="lazy" 
          allow="clipboard-write"
          scrolling="no">
        ...
        <iframe 
          className="iframe w-full md:min-h-[30rem] min-h-[20rem] border-0"
          src="https://www.behance.net/embed/project/191810923?ilo0=1" 
          allowFullScreen 
          loading="lazy" 
          allow="clipboard-write"
          scrolling="no">
        ...
        <iframe 
          className="iframe w-full md:min-h-[30rem] min-h-[20rem] border-0"
          src="https://www.behance.net/embed/project/180210327?ilo0=1" 
          allowFullScreen 
          loading="lazy" 
          allow="clipboard-write"
          scrolling="no">
