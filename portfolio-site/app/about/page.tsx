...
export default function About() {
  return (
    <section className="md:p-12 pt-0 px-0">
      ...
      <iframe className="my-12 md:w-[90%] w-full md:h-[50rem] h-[20rem] mx-auto md:mb-24 mb-12" src="https://www.youtube.com/embed/IzcqeaGWoJQ?si=y6Hh1KujGfjt5siN" title="국립남도국악원 - Jindo National Gugak Center - 사믈놀이 공연" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
